...
BAKERY_DIRS = (
    ...
    # ComputeClaw value-stack (first revenue-facing compute claw)
    "compute-claw/raw-intakes",
    "compute-claw/normalized-assets",
    "compute-claw/market-observations/ebay/raw-batches",
    "compute-claw/market-observations/ebay/normalized",
    "compute-claw/market-observations/ebay/excluded",
    "compute-claw/market-observations/ebay/included-candidates",
    "compute-claw/market-observations/ebay/receipts",
    "compute-claw/benchmark-evidence",
    "compute-claw/utility-evidence",
    "compute-claw/aiov-drafts",
    "compute-claw/validator-review",
    "compute-claw/receipts",
    "compute-claw/deed-candidates",
    "compute-claw/events",
    "benchmark-packs",
    "holdouts/sealed",
    "holdouts/manifests",
